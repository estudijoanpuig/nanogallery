...
<body>
    ...
    <div class="uk-container uk-margin-large-top">
        <div class="uk-grid-match uk-child-width-1-2@m" uk-grid>
            <div>
                <h1 class="gradient-text uk-text-bold ">Insta.lacio i configuracio de NanoGallery PhotosProvider<span class="uk-text-primary"> html UIkit</span></h1>
    ...
    <div class="uk-container uk-margin-large">
        <h2 class="gradient-text uk-text-bold ">nanoPhotosProvider2 usage</h2>
...
&lt;/div&gt;</code></pre>
    ...
    <h1 class="uk-text-center gradient-text uk-text-bold uk-margin-large-top">nanogallery</h1>
...
<a href="#" uk-totop uk-scroll class="uk-position-fixed uk-position-bottom-right uk-position-medium uk-icon-button uk-box-shadow-large" style="background-color: #4D78EF; color: white;"></a>
